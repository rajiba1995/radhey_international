            ...
            <form wire:submit.prevent="update">
                ...
                <div class="row">
                    <div class="mb-3 col-md-4">
                        ...
                        <input type="text" wire:model="mobile" id="mobile" class="form-control form-control-sm border border-1 p-2" placeholder="Staff mobile">
                        @error('mobile')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-8 mt-4 mb-2 d-flex align-items-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" wire:model="account_no" class="form-control form-control-sm border border-1 p-2" placeholder="Account No">
                            @error('account_no')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" wire:model="monthly_salary" class="form-control form-control-sm border border-1 p-2" placeholder="Salary (30 Days)">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" wire:model="daily_salary" class="form-control form-control-sm border border-1 p-2" placeholder="Salary (Per Day)">
                            @error('daily_salary')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" wire:model="travel_allowance" class="form-control form-control-sm border border-1 p-2" placeholder="Travel Allowance">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            <label class="form-label">Address</label>
                            <input type="text" wire:model="address" class="form-control form-control-sm border border-1 p-2" placeholder="Address">
                            @error('address')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" wire:model="pincode" class="form-control form-control-sm border border-1 p-2" placeholder="Pincode">
                            @error('pincode')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
