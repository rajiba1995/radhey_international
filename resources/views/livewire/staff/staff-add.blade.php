        ...
        <div class="card-header pb-0 p-3">
            <div class="row">
                 ...
                 <div class="col-md-6 align-items-center">
                    <div class="row">
                        <div class="col-9">
                            <select wire:change="SelectedCountry"  wire:model="selectedCountryId"   class="form-select me-2 form-control" aria-label="Default select example">
                ...
                <div class="col-md-8 mt-4 d-flex align-items-center">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class=" align-items-center">
                                    <input type="text" wire:model="emergency_whatsapp" class="form-control form-control-sm border border-1 p-2" placeholder="Enter Emergency WhatsApp Number" 
                                    @if($same_as_contact)
                                        disabled
                                    @endif>
                                    ...
                                    <div class="custon-input-group">
                                        ...
                                        @if($same_as_contact)
                                            checked
                                        @endif>
                                        <label for="same_as_contact" class="form-check-label ms-2">Same as Contact Number</label>
                                    </div>
