...
<div class="container-fluid px-2 px-md-4">
    <div class="card card-body">
        ...
        <form wire:submit.prevent="create">
                            ...
                            <!-- <h5 class="mb-4">Add Product</h5> -->
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        @error('collection')<p class='text-danger inputerror'>{{ $message }}</p>@enderror
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        @error('category_id')<p class='text-danger inputerror'>{{ $message }}</p>@enderror
                                    </div>

                                    <!-- Product Name -->
                                    <div class="mb-3 col-md-5">
                                        <label class="form-label">Product Name <span class="text-danger">*</span></label>
                                        <input wire:model="name" type="text" class="form-control form-control-sm border border-1 p-2" placeholder="Enter Product Name">
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        @error('product_code')<p class='text-danger inputerror'>{{ $message }}</p>@enderror
                                    </div>

                                    <!-- Short Description -->
                                    <div class="mb-3 col-md-12">
                                        <label class="form-label">Short Description</label>
                                        <textarea wire:model="short_description" id="short_description" class="form-control form-control-sm border border-1 p-2" rows="3"></textarea>
                                        @error('short_description')<p class='text-danger inputerror'>{{ $message }}</p>@enderror
                                    </div>

                                    <!-- Description -->
                                    <div class="mb-3 col-md-12">
                                        <label class="form-label">Description</label>
                                        <textarea wire:model="description" id="description" class="form-control form-control-sm border border-1 p-2" rows="5"></textarea>
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        @error('gst_details')<p class='text-danger inputerror'>{{ $message }}</p>@enderror
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-9">
                                        ...
                                        @error('selectedFabrics')<p class="text-danger inputerror">{{ $message }}</p>@enderror
                                    </div>
            ...
            <div class="d-flex justify-content-start mt-auto" style="position: relative; bottom: 0; left: 0;">
