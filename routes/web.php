...
use App\Http\Livewire\Order\{OrderIndex, OrderNew, OrderInvoice,OrderEdit,OrderView,LedgerView,AddOrderSlip,InvoiceList,InvoiceEdit};
...
Route::group(['prefix' => 'admin', 'middleware' => 'web'], function () {
    ...
    Route::group(['prefix' => 'orders'], function () {
        ...
        Route::get('/invoice/edit/{id}', InvoiceEdit::class)->name('admin.order.invoice.edit');
    });
});