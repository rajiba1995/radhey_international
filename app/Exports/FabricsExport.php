...
class FabricsExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    {
        return Fabric::with('collection')->select('id', 'collection_id', 'title', 'threshold_price', 'image', 'status')->get();
    }

    // Define Column Headers
    public function headings(): array
    {
        return ['ID', 'Collection Title', 'Title', 'Threshold Price', 'Image', 'Status'];
    }
